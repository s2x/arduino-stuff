...
#define PIN_DIODE_1 9
#define PIN_DIODE_2 8
...
void setup(void)
{
  ...
  pinMode( PIN_DIODE_2  , OUTPUT );

  digitalWrite( PIN_DIODE_1 , LOW );
  digitalWrite( PIN_DIODE_2 , LOW );
...
void loadConfigFromEEPROM()
{
  ...
  if (tmp == 255) {
    EEPROM.write(EEPROM_START_TEMP_ADDRESS, start_temp);
  ...
  if (tmp == 255) {
    EEPROM.write(EEPROM_STOP_TEMP_ADDRESS, stop_temp);
  ...
  if (numberOfDevices == 0) {
    ...
    for (int i = 0; i < numberOfDevices; i++)
    {
      ...
      if (sensors.getAddress(tempDeviceAddress, i))
      {
        ...
        Serial.print("*C");
        //
        if (tempC > 35.0)   digitalWrite( PIN_DIODE_1 , HIGH );
        if (tempC < 30.0)   digitalWrite( PIN_DIODE_1 , LOW );
